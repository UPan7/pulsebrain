...
STRINGS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "remove_confirm_prompt": "Что сделать с каналом {name}?",
        "remove_btn_pause": "⏸ Пауза",
        "remove_btn_delete": "🗑 Удалить",
        "remove_deleted": "🗑 Канал {name} удалён.",
        "add_reenabled": "✅ Канал {name} снова активен.",
    ...
    "en": {
        ...
        "remove_confirm_prompt": "What to do with channel {name}?",
        "remove_btn_pause": "⏸ Pause",
        "remove_btn_delete": "🗑 Delete",
        "remove_deleted": "🗑 Channel {name} removed.",
        "add_reenabled": "✅ Channel {name} re-enabled.",
    ...
    "de": {
        ...
        "remove_confirm_prompt": "Was soll mit Kanal {name} passieren?",
        "remove_btn_pause": "⏸ Pausieren",
        "remove_btn_delete": "🗑 Löschen",
        "remove_deleted": "🗑 Kanal {name} gelöscht.",
        "add_reenabled": "✅ Kanal {name} wieder aktiviert.",
    ...
    "fr": {
        ...
        "remove_confirm_prompt": "Que faire avec la chaîne {name} ?",
        "remove_btn_pause": "⏸ Mettre en pause",
        "remove_btn_delete": "🗑 Supprimer",
        "remove_deleted": "🗑 Chaîne {name} supprimée.",
        "add_reenabled": "✅ Chaîne {name} réactivée.",
    ...
    "es": {
        ...
        "remove_confirm_prompt": "¿Qué hacer con el canal {name}?",
        "remove_btn_pause": "⏸ Pausar",
        "remove_btn_delete": "🗑 Eliminar",
        "remove_deleted": "🗑 Canal {name} eliminado.",
        "add_reenabled": "✅ Canal {name} reactivado.",
    ...
    "it": {
        ...
        "remove_confirm_prompt": "Cosa fare con il canale {name}?",
        "remove_btn_pause": "⏸ Metti in pausa",
        "remove_btn_delete": "🗑 Elimina",
        "remove_deleted": "🗑 Canale {name} eliminato.",
        "add_reenabled": "✅ Canale {name} riattivato.",
    ...
    "pt": {
        ...
        "remove_confirm_prompt": "O que fazer com o canal {name}?",
        "remove_btn_pause": "⏸ Pausar",
        "remove_btn_delete": "🗑 Excluir",
        "remove_deleted": "🗑 Canal {name} excluído.",
        "add_reenabled": "✅ Canal {name} reativado.",
    ...
    "zh": {
        ...
        "remove_confirm_prompt": "如何处理频道 {name}？",
        "remove_btn_pause": "⏸ 暂停",
        "remove_btn_delete": "🗑 删除",
        "remove_deleted": "🗑 频道 {name} 已删除。",
        "add_reenabled": "✅ 频道 {name} 已重新启用。",
    ...
    "ja": {
        ...
        "remove_confirm_prompt": "チャンネル {name} をどうしますか？",
        "remove_btn_pause": "⏸ 一時停止",
        "remove_btn_delete": "🗑 削除",
        "remove_deleted": "🗑 チャンネル {name} を削除しました。",
        "add_reenabled": "✅ チャンネル {name} を再有効化しました。",
    ...
    "ar": {
        ...
        "remove_confirm_prompt": "ماذا تريد أن تفعل بالقناة {name}؟",
        "remove_btn_pause": "⏸ إيقاف مؤقت",
        "remove_btn_delete": "🗑 حذف",
        "remove_deleted": "🗑 تم حذف القناة {name}.",
        "add_reenabled": "✅ تم إعادة تفعيل القناة {name}.",
